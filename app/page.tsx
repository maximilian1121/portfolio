    ...
    <div className="max-w-3xl py-12 space-y-8 mx-2 md:mx-auto">
      ...
      <div className="flex gap-10 align-top justify-center flex-col transition-all">
        <div className="flex flex-row gap-10 justify-center align-middle flex-wrap md:flex-nowrap transition-all">
          <img className="dark:hidden" src="https://github-readme-stats.vercel.app/api?username=maximilian1121"></img>
          <img className="dark:block hidden" src="https://github-readme-stats.vercel.app/api?username=maximilian1121&theme=dark"></img>
          <img className="dark:hidden" src="https://github-readme-stats.vercel.app/api/top-langs/?username=maximilian1121"></img>
          <img className="dark:block hidden" src="https://github-readme-stats.vercel.app/api/top-langs?username=maximilian1121&theme=dark"></img>
        </div>
